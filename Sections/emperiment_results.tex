...
For this experiment, the same 660 training and 300 test features were used as the mood primitives and likeability model experiments. The binarized version of the big five personality trait and interview variables were used to train the model. 
